...
const testimonials: Testimonial[] = [
  {
    ...
    author: "Carolyne Mwangi",
    role: "Founder & CEO",
    company: "Kimplanter Seedlings & Nurseries, Ruiru",
    rating: 5,
    project: "Website Redesign & SEO",
  },
  {
    quote: "Working with TECHNERV on our custom website was an absolute game-changer. They understood our complex workflows immediately and delivered a solution that saved our team 15+ hours per week on manual booking processes.",
    author: "Tony Mwangi",
    role: "Operations Manager",
    company: "Precious Watersports, Diani.",
    rating: 5,
    project: "Custom Business Website Application",
  },
  {
    quote: "The AI-powered affiliate marketing ecommerce platform they built for us has completely revolutionized our business pipeline. Quality is consistently high, and the ROI was apparent within weeks of launch.",
    author: "Rebecca Becky",
    role: "CEO",
    company: "Vidah Ventures, Uganda.",
    rating: 5,
    project: "Online Shopping & Marketplace Platform",
  },
  {
